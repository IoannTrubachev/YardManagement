...
define('IMG_PATH', 'public/img/dart.png');
 ...
 * define('DB_HOST', '10.2.0.237:3388');
...
define('DB_NAME', 'yardmanagement');
define('DB_USER', 'root');
define('DB_PASS', 'Pa10-Pending');
...
define("EMAIL_USE_SMTP", true);
// name of your host
define("EMAIL_SMTP_HOST", '10.2.0.5');
...
define("EMAIL_PASSWORD_RESET_FROM_EMAIL", "no-reply@dart.biz");
define("EMAIL_PASSWORD_RESET_FROM_NAME", "DTY Password reset");
define("EMAIL_PASSWORD_RESET_SUBJECT", "Password reset for DTY");
define("EMAIL_PASSWORD_RESET_CONTENT", "PLEASE DO NOT REPLY TO THIS EMAIL! Please click on this link to reset your password: ");

define("EMAIL_VERIFICATION_URL", URL . "login/verify");
define("EMAIL_VERIFICATION_FROM_EMAIL", "no-reply@dart.biz");
define("EMAIL_VERIFICATION_FROM_NAME", "DTY Activation");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for DTY");
define("EMAIL_VERIFICATION_CONTENT", "Please click on this link to activate your account: ");
...
define("FEEDBACK_FULLNAME_FIELD_EMPTY", "Full name field was empty.");
define("FEEDBACK_LOCATION_FIELD_EMPTY", "Location field was empty.");
...
define("FEEDBACK_DUPLICATE_TRAILER", "DUPLICATE TRAILER CODE, Please rename or request the trailer from another plant that has the trailer. If you believe this is a mistake, please contact the site Administrator.");
...
define("FEEDBACK_LOCATION_SAME_AS_OLD_ONE", "Sorry, that location is the same as your current one. Please choose another one.");
define("FEEDBACK_FULLNAME_SAME_AS_OLD_ONE", "Sorry, the full name is the same as your current one.");
...
define("FEEDBACK_FULLNAME_CHANGE_SUCCESSFUL", "Your full name has been changed successfully.");
define("FEEDBACK_LOCATION_CHANGE_SUCCESSFUL", "Your location has been changed successfully.");
...
define("FEEDBACK_FULLNAME_DOES_NOT_FIT_PATTERN", "Full name does not fit the name scheme: only a-Z and numbers are allowed, 2 to 64 characters.");
define("FEEDBACK_USER_FULL_NAME_DOES_NOT_FIT_PATTERN", "Username does not fit the name scheme: only a-Z and numbers are allowed, 2 to 64 characters.");
define("FEEDBACK_EMAIL_DOES_NOT_FIT_PATTERN", "Sorry, your chosen email does not fit into the email naming pattern.");
define("FEEDBACK_LOCATION_DOES_NOT_FIT_PATTERN", "Sorry, The location does not fit the naming pattern, please remove special characters. Only A-Z, and 1-9.");
define("FEEDBACK_NOTES_DOES_NOT_FIT_PATTERN", "Sorry, notes cannot have special characters other than ' ! @ # $ % & ?. , , please remove special characters. Only A-Z,1-9, and ' ! @ # $ % & ?. , .");
...
define("FEEDBACK_FULLNAME_TOO_SHORT_OR_TOO_LONG", "Full name cannot be shorter than 2 or longer than 64 characters.");
